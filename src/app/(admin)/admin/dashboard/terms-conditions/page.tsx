...
export default function TermsConditionsManager() {
  ...
  async function loadPageData() {
    try {
      setLoading(true);
      const res = await fetch("/api/admin/terms-conditions-page", {
        credentials: "include",
      });
      ...
      toast.error("Failed to load terms & conditions page data");
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <div className="space-y-6 animate-fadeUp">
      ...
      <p className="text-muted-foreground">
        Manage all content displayed on the public Terms & Conditions page.
      </p>
          ...
          <CardContent className="p-6 space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="By accessing and using the Mera Pind Balle Balle website..."
                rows={4}
              />
            </div>
            ...
            <CardContent className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold">
                  Terms Sections ({pageData.sections.length})
                </h2>
                <Button
                  variant="outline"
                  onClick={addSection}
              ...
              <div className="space-y-4">
                ...
                {pageData.sections.length === 0 && (
                  <p className="text-center text-muted-foreground py-8">
                    ...
                    building your terms & conditions.
                  </p>
                )}
              </div>
            </CardContent>
        ...
        <Card>
          <CardContent className="p-6 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Displayed at the bottom of the terms & conditions page.
            </p>
      ...
      >
        {submitting ? "Saving..." : "Save Terms & Conditions Page"}
      </Button>
    </div>
  );
}
